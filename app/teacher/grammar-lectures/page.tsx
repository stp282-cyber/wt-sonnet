...
import { IconPlus, IconTrash, IconDeviceFloppy, IconVideo, IconEdit, IconCheck, IconX, IconMenu2 } from '@tabler/icons-react';
    ...
    return (
        <Container fluid p="lg" style={{ color: 'white' }}>
            ...
            <DragDropContext onDragEnd={onDragEnd}>
                <Stack gap="lg">
                    {books.map((book) => (
                        <Paper key={book.id} p="md" style={{ backgroundColor: '#1E293B', borderColor: '#334155' }} withBorder>
                            <Group justify="space-between" mb="md">
                                <Text size="lg" fw={700} c="yellow.4">{book.title}</Text>
                                <Group>
                                    ...
                                    <Accordion.Item key={chapter.id} value={chapter.id} style={{ backgroundColor: '#0F172A' }}>
                                        <Accordion.Control>
                                            <Group justify="space-between">
                                                <Text c="white">{chapter.title}</Text>
