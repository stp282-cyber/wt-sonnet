...
import StudentGreeting from './Greeting'; // Client Component for user name
import { getGrammarTitles } from '@/lib/grammar'; // Direct DB fetch

// Server Component (Async)
export default async function StudentHomePage() {
    // Fetch books directly on the server
    // This happens BEFORE the HTML is sent to the browser
